...
La distancia en l\'inea recta a un establecimiento de salud subestima
sistem\'aticamente ese
...
contribuci\'on de cada establecimiento a la cobertura ---, y (ii) \emph{a\~nadir} un
...
\begin{figure}[H]
  ...
  \caption{Distribuci\'on del tiempo de acceso al establecimiento de salud resolutivo m\'as
...
\begin{itemize}
  ...
  \item Tiempo medio ponderado \num{30.9}~min; mediana de centros poblados
        \num{63.8}~min: la poblaci\'on se concentra cerca de los establecimientos de salud,
...
\begin{itemize}
  ...
  \item \textbf{Efectos de borde.} S\'olo se consideran establecimientos
        ...
        podr\'ia tener m\'as cerca un establecimiento de salud de la regi\'on
        vecina.
\end{itemize}
