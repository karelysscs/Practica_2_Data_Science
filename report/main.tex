...
\begin{verbatim}
python -m src.phase1_data      # validacion + reportes de calidad
python -m src.phase2_routing   # matriz O-D via OSRM (cache reanudable)
python -m src.phase3_metrics   # metricas, Gini, cruces, GeoPackage
python -m src.figures          # figuras .png y tablas .tex
